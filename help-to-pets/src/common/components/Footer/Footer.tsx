    ...
    <footer className={classes.footer}>
      <div className={classes.footer__wrapper}>
        <div className={classes.footer__container}>
          <div
            className={[classes.footer__links, classes.footer__items].join('')}
          >
            <h4 className={classes.title}>CONTEÚDO</h4>
            <a href="" className={classes.links__item}>
              Home
            </a>
            <a href="#" className={classes.links__item}>
              Centrais
          ...
          <div
            className={[classes.footer__info, classes.footer__items].join('')}
          >
          ...
          <div
            className={[classes.footer__social, classes.footer__items].join('')}
          >
            ...
            <p className={classes.social__description}>
